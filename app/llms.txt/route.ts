...
- Importing, editing and printing recipes is free and requires no account. Two things are paid, and both are yours once bought: premium print themes, each one yours for life, and the cookbook builder, paid for per cookbook built rather than once for the feature. There is no subscription and nothing renews. Prices are shown before you buy.
