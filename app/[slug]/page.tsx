              ...
              {page.faqs.map((item, index) => (
                ...
                >
                  <dt className="flex items-start gap-cp-3 text-cp-body-lg font-extrabold leading-snug tracking-[-0.02em]">
                    <span
                      className="grid h-8 w-8 flex-none place-items-center rounded-full border border-[var(--cp-accent)] bg-[var(--cp-accent-soft)] text-cp-small font-black text-[var(--cp-ink)]"
                      aria-hidden
                    >
                      {index + 1}
                    </span>
