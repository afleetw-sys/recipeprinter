 ...
 * therefore usually fully recoverable by a single click — the state that
 * matters was never in React to begin with.
 *
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-cp-4 text-center px-cp-6">
        <p className="font-bold text-cp-h2">Something went wrong here</p>
        <p className="text-ink-soft max-w-sm">
          The print preview hit an unexpected error. Your recipes are still saved in this
          tab — try again, and they should come right back.
        </p>
