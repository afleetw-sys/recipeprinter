 ...
 * (exactly like importing one normally), applies the original print settings,
 * then redirects into /print?ids=...&shared=1. That's what keeps the
 * shared-link experience — including premium template gating, the settings
 * panel, and every future change to /print — in sync with the real product
