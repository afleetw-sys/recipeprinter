...
// The image tables live in lib/seoAssets now (a server route reads them);
// re-exported here because this is where they are drawn and where callers
// already look for them.
export { FEATURE_IMAGES };
